...
## [28.0.4](https://github.com/vianetwork/via-core/compare/core-v28.0.3...core-v28.0.4) (2025-12-30)
...
* **contracts:** integrate protocol defense changes ([#2737](https://github.com/vianetwork/via-core/issues/2737))

### Features

* add `block.timestamp` asserter for AA ([4d0af43](https://github.com/vianetwork/via-core/commit/4d0af43eef617d0226b24d3532c65c473c381cd8))
* add `block.timestamp` asserter for AA ([#3031](https://github.com/vianetwork/via-core/issues/3031)) ([3c20a7c](https://github.com/vianetwork/via-core/commit/3c20a7cd8ea8f131e275d33b240f246c7efbce2f))
* Add CoinMarketCap external API ([#2971](https://github.com/vianetwork/via-core/issues/2971)) ([ec78d51](https://github.com/vianetwork/via-core/commit/ec78d5186f375b8bb5a166b7dea12582047ebee5))
...
* add logic to via modules to stop operating when a reorg is found ([1ea291c](https://github.com/vianetwork/via-core/commit/1ea291cd0a4d4cfb050adaae9245a5b50b7e1f4e))
* add logs ([cc3e4d4](https://github.com/vianetwork/via-core/commit/cc3e4d4508488e10b4002f63d1ca20f8ba806a75))
* add more metrics for the tee_prover ([#3276](https://github.com/vianetwork/via-core/issues/3276)) ([504c382](https://github.com/vianetwork/via-core/commit/504c3825b18e74cdbd2412c3df4107fa54b96cd8))
* add reorg detector config ([1368384](https://github.com/vianetwork/via-core/commit/1368384a3e2357dfe3a9c4910954e30c6b7ba21c))
* add support for custom genesis state ([#3259](https://github.com/vianetwork/via-core/issues/3259)) ([5f2b312](https://github.com/vianetwork/via-core/commit/5f2b312f2850305bdd7112fdfc23b0508057af4c))
* add the l1 block number to the system wallet and create a new dal to track the node blocks ([3982c3d](https://github.com/vianetwork/via-core/commit/3982c3d0179221dad96733378f502efe6194ca2f))
* allow vm2 tracers to stop execution ([#3183](https://github.com/vianetwork/via-core/issues/3183)) ([bb529da](https://github.com/vianetwork/via-core/commit/bb529dad37bc8808bbb6450a6f5c732faebe2ddf))
* **api_server:** support the blob pub and the proof data ([51e4b5e](https://github.com/vianetwork/via-core/commit/51e4b5e0ffc94af3488e49d2149949b439774c57))
* **api-server:** add `yParity` for non-legacy txs ([#3246](https://github.com/vianetwork/via-core/issues/3246)) ([d05dba2](https://github.com/vianetwork/via-core/commit/d05dba2e26afe7dac4ba6cf8b3b5e826cbf9c205))
* **api:** get rid of tx receipt root ([#3187](https://github.com/vianetwork/via-core/issues/3187)) ([d36d4e6](https://github.com/vianetwork/via-core/commit/d36d4e6f1f5e89760cccf3798d009cd1ba7e9e0d))
* **api:** Implement eth_maxPriorityFeePerGas ([#3135](https://github.com/vianetwork/via-core/issues/3135)) ([3229b17](https://github.com/vianetwork/via-core/commit/3229b175ce733ba343c3424eb69f259275032794))
* **api:** include cache log config to Via binaries ([f3b7e1a](https://github.com/vianetwork/via-core/commit/f3b7e1a21acfac34f7f164f916bcb8bd6f617ddf))
* **api:** Integrate new VM into API server (no tracers) ([#3033](https://github.com/vianetwork/via-core/issues/3033)) ([631db04](https://github.com/vianetwork/via-core/commit/631db04e0692d2f2beb1dc1508af710ff8b6d33c))
* **api:** Make acceptable values cache lag configurable ([#3028](https://github.com/vianetwork/via-core/issues/3028)) ([c0d8681](https://github.com/vianetwork/via-core/commit/c0d8681977b13f1aac21a8cc75aabe58dd63d1d9))
* base token integration tests ([#2509](https://github.com/vianetwork/via-core/issues/2509)) ([d7680a2](https://github.com/vianetwork/via-core/commit/d7680a2867a35af120fcdab8430725eadb505037))
* change seal criteria for gateway ([#3320](https://github.com/vianetwork/via-core/issues/3320)) ([edbdfe5](https://github.com/vianetwork/via-core/commit/edbdfe58eb164e67fce47f830e49017ff8eba527))
...
* **consensus:** enabled syncing pregenesis blocks over p2p ([#3192](https://github.com/vianetwork/via-core/issues/3192)) ([e3bcb14](https://github.com/vianetwork/via-core/commit/e3bcb14936e1d914282922c0bc01f47d708dde14))
* **consensus:** fallback json rpc syncing for consensus ([#3211](https://github.com/vianetwork/via-core/issues/3211)) ([c2c6752](https://github.com/vianetwork/via-core/commit/c2c6752d47d64f1ab2d6692d70d567d4f7868b55))
* **contract-verifier:** Adapt contract verifier API for EVM bytecodes ([#3234](https://github.com/vianetwork/via-core/issues/3234)) ([000bcc7](https://github.com/vianetwork/via-core/commit/000bcc7fab833b391a458c3d76d329a662cb3b51))
* **contract-verifier:** Download compilers from GH automatically ([#3291](https://github.com/vianetwork/via-core/issues/3291)) ([b0b548d](https://github.com/vianetwork/via-core/commit/b0b548d57fc24d22ce24c01bd39dcedd7d37babd))
* **contract-verifier:** Support Solidity contracts with EVM bytecode in contract verifier ([#3225](https://github.com/vianetwork/via-core/issues/3225)) ([d8714d3](https://github.com/vianetwork/via-core/commit/d8714d3cf4b7bd5b7f2933b38b9069c9692d1f8f))
* **contract-verifier:** Support Vyper toolchain for EVM bytecodes ([#3251](https://github.com/vianetwork/via-core/issues/3251)) ([90455bc](https://github.com/vianetwork/via-core/commit/90455bcc22d498f0165ad536d1a46f4189a8e45e))
* **contracts:** integrate protocol defense changes ([#2737](https://github.com/vianetwork/via-core/issues/2737)) ([cb5f3c2](https://github.com/vianetwork/via-core/commit/cb5f3c2aeb7fcf5aaad8d59d47aadd234db1aec2))
...
* **da-clients:** add Celestia client ([#2983](https://github.com/vianetwork/via-core/issues/2983)) ([90ab192](https://github.com/vianetwork/via-core/commit/90ab19267475d1f99ed4d2580f8c230767aa2e6e))
* **da-clients:** add EigenDA client ([#3155](https://github.com/vianetwork/via-core/issues/3155)) ([ccca0dc](https://github.com/vianetwork/via-core/commit/ccca0dc2b1f913cd52d5f2e7f3664062b1715a42))
...
* **en:** Support Merkle tree recovery with pruning enabled ([#3172](https://github.com/vianetwork/via-core/issues/3172)) ([d87c5dc](https://github.com/vianetwork/via-core/commit/d87c5dc01969f96eeda9249a02a89fc9f67d19e0))
* **external-node:** save protocol version before opening a batch ([#3136](https://github.com/vianetwork/via-core/issues/3136)) ([9d388a9](https://github.com/vianetwork/via-core/commit/9d388a90553ca210130f4793fd851acc47f7cfa3))
...
* gateway preparation ([60562af](https://github.com/vianetwork/via-core/commit/60562af6c9c1ac162387cb723cbd8774da91e889))
* gateway preparation ([#3006](https://github.com/vianetwork/via-core/issues/3006)) ([7f9e80d](https://github.com/vianetwork/via-core/commit/7f9e80d448ea564b5e83dbba6d6010518dc9511f))
* Implement gas relay mode and inclusion data for data attestation ([#3070](https://github.com/vianetwork/via-core/issues/3070)) ([c931e7d](https://github.com/vianetwork/via-core/commit/c931e7dc6f2a749df112d50a0e7f9b8762adcfaa))
* integrate gateway changes for some components ([9a671cc](https://github.com/vianetwork/via-core/commit/9a671cc57f502c8607232067a751cfc53c59d762))
* integrate gateway changes for some components ([#3274](https://github.com/vianetwork/via-core/issues/3274)) ([0354888](https://github.com/vianetwork/via-core/commit/03548885eb9b4b82956a4ead03ec1ca00056c3f4))
* **metadata-calculator:** Add debug endpoints for tree API ([#3167](https://github.com/vianetwork/via-core/issues/3167)) ([6880f73](https://github.com/vianetwork/via-core/commit/6880f7337aa49b49a0f0996d0b4d3c18ffb11af2))
...
* **proof-data-handler:** add first processed batch option ([#3112](https://github.com/vianetwork/via-core/issues/3112)) ([0b0cce2](https://github.com/vianetwork/via-core/commit/0b0cce220da01ff3e9995717991aad39a5fae313))
* **proof-data-handler:** add tee_proof_generation_timeout_in_secs param ([#3128](https://github.com/vianetwork/via-core/issues/3128)) ([0035de4](https://github.com/vianetwork/via-core/commit/0035de40fafd50d66f55700011ded831aef52d13))
* **proof-data-handler:** exclude batches without object file in GCS  ([#2980](https://github.com/vianetwork/via-core/issues/2980)) ([4d0540c](https://github.com/vianetwork/via-core/commit/4d0540cbefc9ecd7831bf555bfbee1cc257235c2))
* Prover e2e test ([#2975](https://github.com/vianetwork/via-core/issues/2975)) ([e239e67](https://github.com/vianetwork/via-core/commit/e239e67b514c21636ef979b7c8fc628d721caf2c))
* **prover:** Add min_provers and dry_run features. Improve metrics and test. ([#3129](https://github.com/vianetwork/via-core/issues/3129)) ([a7d729c](https://github.com/vianetwork/via-core/commit/a7d729c4dfbda19bcfd4dc6270b1d4d39db1e7d3))
* **prover:** Add queue metric to report autoscaler view of the queue. ([#3206](https://github.com/vianetwork/via-core/issues/3206)) ([7e2f9fa](https://github.com/vianetwork/via-core/commit/7e2f9fa38188f7b6baf9d467f3a465e0c1c311fc))
* **prover:** Add sending scale requests for Scaler targets ([#3194](https://github.com/vianetwork/via-core/issues/3194)) ([6bc89c6](https://github.com/vianetwork/via-core/commit/6bc89c624ad235461c77f6201338950d96f2d5a7))
* **prover:** Add support for scaling WGs and compressor ([#3179](https://github.com/vianetwork/via-core/issues/3179)) ([f0098c8](https://github.com/vianetwork/via-core/commit/f0098c846ca44f0dafacdf19a8611d5e45f3203d))
* ProverJobProcessor & circuit prover ([#3287](https://github.com/vianetwork/via-core/issues/3287)) ([1e5855c](https://github.com/vianetwork/via-core/commit/1e5855c53fd9a3b36e7abd657aa6c9b752ed3545))
* **prover:** Move prover_autoscaler config into crate ([#3222](https://github.com/vianetwork/via-core/issues/3222)) ([35f796c](https://github.com/vianetwork/via-core/commit/35f796c101e1694026f21b327323918521567c6d))
* **pruning:** Record L1 batch root hash in pruning logs ([#3266](https://github.com/vianetwork/via-core/issues/3266)) ([ca13217](https://github.com/vianetwork/via-core/commit/ca13217266ecb97ad4ed73738cb29cb0a10975fe))
...
* **state-keeper:** mempool io opens batch if there is protocol upgrade tx ([#3360](https://github.com/vianetwork/via-core/issues/3360)) ([c6218f6](https://github.com/vianetwork/via-core/commit/c6218f6597ff0199c29d4c7d60df0a539f401c9e))
...
* **tee_verifier:** speedup SQL query for new jobs ([#3133](https://github.com/vianetwork/via-core/issues/3133)) ([86999de](https://github.com/vianetwork/via-core/commit/86999deed2ea4a0ba908782e32ed39e2ee34cb63))
* **tee:** add error handling for unstable_getTeeProofs API endpoint ([#3321](https://github.com/vianetwork/via-core/issues/3321)) ([98c9dd9](https://github.com/vianetwork/via-core/commit/98c9dd9eb95699d0eb601bb730e8e74c59d301c7))
* **vai_da_dispatcher_lib:** add reusable code in the vai_da_dispatcher_lib ([b4d6c04](https://github.com/vianetwork/via-core/commit/b4d6c04b998f51f19ae5f906c3a168c14b9403b8))
* **via_block_reverter:** integrate the reorg logic to the block reverter and add helpers to clean the state ([b1a43b1](https://github.com/vianetwork/via-core/commit/b1a43b173c52752d9eaf4f56df5f4cf5ba1cce78))
* **via_btc_client:** implement the withdrawal parser and fix tests ([40c4b39](https://github.com/vianetwork/via-core/commit/40c4b39a76a80af9bf40a8831c8ea3d940df0300))
* **via_btc_sender:** wait for DA inclusion before process inscriptions ([b187ad5](https://github.com/vianetwork/via-core/commit/b187ad589da14b5ee9026b4c754082af4b3aecd1))
* **via_btc_watch:** moving the state init from the node btc watch to node init module ([0b80d25](https://github.com/vianetwork/via-core/commit/0b80d25ffa9a6c0fdd6eee7c2f55b484e90b844b))
* **via_config:** add l2 secrets config ([c42c71d](https://github.com/vianetwork/via-core/commit/c42c71d6057d8dd35057eed3fa46bde46609b428))
* **via_core:** improve logging and metrics ([cfec275](https://github.com/vianetwork/via-core/commit/cfec2756997111bd7dc107d33249171c490df0bd))
* **via_da_client_en:** add logic to return proof data and make the EN client optional for the node ([9364422](https://github.com/vianetwork/via-core/commit/9364422a4b9272796c54ea2da468c19043575735))
* **via_da_client:** add chunk reconstruction logic to the celestia client ([ac9be12](https://github.com/vianetwork/via-core/commit/ac9be12674be568b6ac92b20e598b29145a6fcea))
* **via_da_dispatcher:** implement chunk blob logic ([6c38444](https://github.com/vianetwork/via-core/commit/6c384449a4fc6308a30ed6707a1d0fb96e549f08))
* **via_external_node:** add reorg detector to the EN ([fc9871a](https://github.com/vianetwork/via-core/commit/fc9871a01d08812332aa7e1ccf35208757e9b1fb))
* **via_main_node_reorg_detector:** implement the node reorg detector ([1d429f9](https://github.com/vianetwork/via-core/commit/1d429f9d2e77e524d0ccb8e0d08c8e3d972c0764))
...
* **via_server:** integrate the reorg detector to the server orchestration layer ([23c88ba](https://github.com/vianetwork/via-core/commit/23c88ba5b6dfbf7667fa651c57dc7bf441a33119))
...
* **via_state_keeper:** mempool io opens batch if there is protocol upgrade tx ([b66786b](https://github.com/vianetwork/via-core/commit/b66786b5c1e8a13e133743d7db8482b7f11f9521))
...
* **via-cli:** update the deposit cmd to allow external api for fee ([da95b10](https://github.com/vianetwork/via-core/commit/da95b10bfabcb1adf265e7c089e930c8dbaf31dd))
* **via-da-http:** implement an http DA client ([ae78f47](https://github.com/vianetwork/via-core/commit/ae78f47a8576b7fa7e953547ad61bb7d91bb027e))
* **vm_executor:** Add new histogram metric for gas per tx in vm_executor ([#3215](https://github.com/vianetwork/via-core/issues/3215)) ([131c383](https://github.com/vianetwork/via-core/commit/131c383d0c5483b5f9138180b50c3f8100a890c9))
* vm2 account validation ([#2863](https://github.com/vianetwork/via-core/issues/2863)) ([156f325](https://github.com/vianetwork/via-core/commit/156f325d99f50efcf3fffdc25771c5764795f17f))
* vm2 tracers can access storage ([#3114](https://github.com/vianetwork/via-core/issues/3114)) ([513619e](https://github.com/vianetwork/via-core/commit/513619e44efdade5ac3c54d8fca5e667429094e8))
* **vm:** add gateway changes to fast vm ([#3236](https://github.com/vianetwork/via-core/issues/3236)) ([011aa42](https://github.com/vianetwork/via-core/commit/011aa42750372bd7be7c47b00edfde23d7e363ea))
* **vm:** Return compressed bytecodes from `push_transaction()` ([#3126](https://github.com/vianetwork/via-core/issues/3126)) ([2b73705](https://github.com/vianetwork/via-core/commit/2b73705305849086c3c86e9787b0fefc008f3f03))
* **vm:** Support EVM emulation in fast VM ([#3163](https://github.com/vianetwork/via-core/issues/3163)) ([e7d44e1](https://github.com/vianetwork/via-core/commit/e7d44e1731ac581d2199849885571f5f815f1da8))
* **zksync_cli:** Health checkpoint improvements ([#3193](https://github.com/vianetwork/via-core/issues/3193)) ([817a280](https://github.com/vianetwork/via-core/commit/817a280f58932a7fd5f1338159f915489f39a49f))
...
* **api:** batch fee input scaling for `debug_traceCall` ([#3344](https://github.com/vianetwork/via-core/issues/3344)) ([72047e6](https://github.com/vianetwork/via-core/commit/72047e6974fa257c166b62e731b14c38171622c2))
...
* **btc_client:** include the context inscription when calculate the balance. ([ae0c065](https://github.com/vianetwork/via-core/commit/ae0c065632d55802502cab0d45e5c3373437ee84))
...
* **call_tracer:** Flat call tracer fixes for blocks ([#3095](https://github.com/vianetwork/via-core/issues/3095)) ([29e7622](https://github.com/vianetwork/via-core/commit/29e7622c530877d60c3dff9a76ee7a22aabc3ebf))
...
* **consensus:** better logging of errors ([#3170](https://github.com/vianetwork/via-core/issues/3170)) ([d47306e](https://github.com/vianetwork/via-core/commit/d47306e030827e22ef70ce5c6794ca28560e4353))
* **consensus:** made attestation controller non-critical ([#3180](https://github.com/vianetwork/via-core/issues/3180)) ([b41211c](https://github.com/vianetwork/via-core/commit/b41211c1210c133e8315749517d6a007865fc7f4))
* **consensus:** payload encoding protected by protocol_version ([#3168](https://github.com/vianetwork/via-core/issues/3168)) ([15eb982](https://github.com/vianetwork/via-core/commit/15eb982bfe0ef082d9e12bf7a8ab116f5e483a0f))
* **consensus:** preventing config update reverts ([#3148](https://github.com/vianetwork/via-core/issues/3148)) ([39037b5](https://github.com/vianetwork/via-core/commit/39037b5943057fd0ddbdb8d3c74a4646e92fb250))
* **contract-verifier:** Fix version extraction in gh resolver ([#3378](https://github.com/vianetwork/via-core/issues/3378)) ([ca0af2a](https://github.com/vianetwork/via-core/commit/ca0af2a57d95daa0dd26233c73f3420223e35d31))
* **da-clients:** add padding to the data within EigenDA blob ([#3203](https://github.com/vianetwork/via-core/issues/3203)) ([d5bb60d](https://github.com/vianetwork/via-core/commit/d5bb60d95447721c9e19a104b02139c9e01958f3))
* **da-clients:** enable tls-roots feature for tonic ([#3201](https://github.com/vianetwork/via-core/issues/3201)) ([cf62f87](https://github.com/vianetwork/via-core/commit/cf62f876532d4b937f43ef72f3d1833b5960ed0b))
* delete priority tx sql query ([915dc66](https://github.com/vianetwork/via-core/commit/915dc660be093bbc2cb03d97860b89567a14f3b4))
* delete soft reorg ([1f6c155](https://github.com/vianetwork/via-core/commit/1f6c1554ae4e6bc3b746e2786ea9f41c838b3a58))
* **en:** fix metrics ([60c7752](https://github.com/vianetwork/via-core/commit/60c7752a35d67d823ddba1314ac4ba280666a0c5))
* **en:** Repair stale keys for tree in background ([c3f8db2](https://github.com/vianetwork/via-core/commit/c3f8db24e48d0f3bd70bfb448896c7ffe82f86b2))
* **en:** resolve node builder issues ([7c17a53](https://github.com/vianetwork/via-core/commit/7c17a532232d6e3217e07fd763d777718a3bff39))
* **en:** Return `SyncState` health check ([#3142](https://github.com/vianetwork/via-core/issues/3142)) ([643ac2f](https://github.com/vianetwork/via-core/commit/643ac2f9a069a39708ebc4cf507a99d7834320cb))
* extend allowed storage slots for validation as per EIP-7562 ([#3166](https://github.com/vianetwork/via-core/issues/3166)) ([3bd787f](https://github.com/vianetwork/via-core/commit/3bd787f6b55a65573536f59ea3a12fbccdd499f6))
* **external-node:** delete empty unsealed batch on EN initialization ([#3125](https://github.com/vianetwork/via-core/issues/3125)) ([6935412](https://github.com/vianetwork/via-core/commit/69354126ad9a96e6306fcf6aab4f9dc35de1d4bc))
* Fix counter metric type to be Counter. ([#3153](https://github.com/vianetwork/via-core/issues/3153)) ([5287880](https://github.com/vianetwork/via-core/commit/52878806258ee5057dda11dae249fc9d9a252654))
* Health checkpoint improvements ([a36bf92](https://github.com/vianetwork/via-core/commit/a36bf922938585cf8a4e7b9523b2f8aa4645c69c))
* **mempool:** minor mempool improvements ([#3113](https://github.com/vianetwork/via-core/issues/3113)) ([383627f](https://github.com/vianetwork/via-core/commit/383627fa5e2b2f8bde081746b4c4ade5bb6e06d5))
* **merkle-tree:** Fix tree truncation ([#3178](https://github.com/vianetwork/via-core/issues/3178)) ([4945611](https://github.com/vianetwork/via-core/commit/49456117b73a8b67fb8e74206c02c4e322b88e16))
* **merkle-tree:** Repair stale keys for tree in background ([#3200](https://github.com/vianetwork/via-core/issues/3200)) ([2e3b0eb](https://github.com/vianetwork/via-core/commit/2e3b0eb0c2ae265e112106196430560b3ff160b7))
* remove bridge address from the via api namespace ([294e8b7](https://github.com/vianetwork/via-core/commit/294e8b70a9b1d0c6f8dd1e682a74422ff7c87b8e))
* reset the indexer last indexed block when a reorg is detected but ([991ae29](https://github.com/vianetwork/via-core/commit/991ae290b4d4145ec2595f44f40aaa22e5536776))
* resovle conflicts among VM versions for Via and ZKsync ([7fe7cc0](https://github.com/vianetwork/via-core/commit/7fe7cc0c6aedb5cf071179225d7182169d8b7287))
* restore instruction count functionality ([#3081](https://github.com/vianetwork/via-core/issues/3081)) ([960a6e3](https://github.com/vianetwork/via-core/commit/960a6e31c7db497e07ba6d6e5c9bebf1f4498efe))
* **state-keeper:** save call trace for upgrade txs ([#3132](https://github.com/vianetwork/via-core/issues/3132)) ([ca98f8c](https://github.com/vianetwork/via-core/commit/ca98f8c5b5c660f7cf2d7804fc5e38eeac242b80))
* **tee_prover:** add prometheus pull listener ([#3169](https://github.com/vianetwork/via-core/issues/3169)) ([da784a1](https://github.com/vianetwork/via-core/commit/da784a1c482e76956967bd2bf1c19696703ff06f))
* **tee_prover:** add zstd compression ([#3144](https://github.com/vianetwork/via-core/issues/3144)) ([19af3e0](https://github.com/vianetwork/via-core/commit/19af3e0528eb650405ccf9d22cfe3eb2f8be0a68))
* **tee_verifier:** correctly initialize storage for re-execution ([#3017](https://github.com/vianetwork/via-core/issues/3017)) ([a650c0c](https://github.com/vianetwork/via-core/commit/a650c0c1aeec184a4400ce5e8d08a3ff614dfa25))
* **tee:** correct previous fix for race condition in batch locking ([#3358](https://github.com/vianetwork/via-core/issues/3358)) ([1bbd054](https://github.com/vianetwork/via-core/commit/1bbd054c747168d9fafefd9f70bbecf83d3ee5c0))
* **tee:** fix race condition in batch locking ([#3342](https://github.com/vianetwork/via-core/issues/3342)) ([8ec4d71](https://github.com/vianetwork/via-core/commit/8ec4d71a22c2eb7775ed121e6af9cb970808f984))
...
* **tracer:** Add error to flat tracer ([#3306](https://github.com/vianetwork/via-core/issues/3306)) ([93999f2](https://github.com/vianetwork/via-core/commit/93999f21b8d857056c8c87656c1daeabb73a0375))
* **tracer:** adds vm error to flatCallTracer error field if exists ([#3374](https://github.com/vianetwork/via-core/issues/3374)) ([96e8585](https://github.com/vianetwork/via-core/commit/96e85850d251ee36f6f2eb49a679f0b020cbe52b))
* update logging in cbt l1 behaviour ([#3149](https://github.com/vianetwork/via-core/issues/3149)) ([5512df6](https://github.com/vianetwork/via-core/commit/5512df62086c71e2ce719b269305452425b31984))
* use_dummy_inclusion_data condition ([#3244](https://github.com/vianetwork/via-core/issues/3244)) ([9d20c50](https://github.com/vianetwork/via-core/commit/9d20c508ae77294c9d122dc9b5f7433eb3f69a8b))
* verifier soft reorg ([b7267f6](https://github.com/vianetwork/via-core/commit/b7267f618c0ae9ab0d75e33e33a57e1bf9f0a198))
* **via_btc_sender:** fix tests ([3e5c0a2](https://github.com/vianetwork/via-core/commit/3e5c0a204df949e7c6787d6ffcf768991668c3c1))
* **via_da_dal:** add helper function to get the proof batch data and fix the pubdata query ([fb895ca](https://github.com/vianetwork/via-core/commit/fb895ca446ee2ee06ba85045a2c618301990222c))
* **via_en:** external node orchestration layer and config ([b4e1f15](https://github.com/vianetwork/via-core/commit/b4e1f15cde6cade1e353c5007f304d5c4be52d7a))
* **via_server:** add missing `gas_adjuster_layer` when initializing only http or ws component ([fe906a2](https://github.com/vianetwork/via-core/commit/fe906a2bfa761a96dc382632cac47fa94f0ae4e7))
* **via_state_keeper:** save call trace for upgrade txs ([1a0631c](https://github.com/vianetwork/via-core/commit/1a0631c1862d6f016369bcc2dd330419d94784ed))
...
* **vm:** Do not require experimental VM config ([#3270](https://github.com/vianetwork/via-core/issues/3270)) ([f932485](https://github.com/vianetwork/via-core/commit/f9324850c4166871c48ceb4c0396322d9e95bce6))
